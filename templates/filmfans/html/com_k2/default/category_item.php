...
$intro = FilmFansHelper::cutString($this->item->introtext, $behaviour == 'review' ? 80 : 200);
        ...
        <div class="ffrating">
            ...
            <div class="ffcomments">
                <a href="<?php echo $this->item->link; ?>#comments">
                    <i><fb:comments-count href="<?php echo trim(JUri::base(), '/').$this->item->link; ?>"></fb:comments-count></i>
                </a>
            </div>
            <?php } ?>
            <div class="clearfix"></div>

...
<div id="modSocialConnectMinimal" class="modSocialConnect<?php echo $moduleClassSuffix; ?>">
	...
	<div class="socialConnectServicesBlock">
		...
		<div class="socialConnectClearFix">
			<?php if($facebook): ?>
			<a title="::Facebook" class="socialConnectFacebookButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $facebookLink; ?>">
				<i></i>
				<span>Facebook</span>
			</a>
			<?php endif; ?>
			<?php if($twitter): ?>
			<a title="::Twitter" class="socialConnectTwitterButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $twitterLink; ?>">
				<i></i>
				<span>Twitter</span>
			</a>
			<?php endif; ?>
			<?php if($google): ?>
			<a title="::Google" class="socialConnectGoogleButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $googleLink; ?>">
				<i></i>
				<span>Google</span>
			</a>
			<?php endif; ?>
			<?php if($googlePlus): ?>
			<a title="::Google+" class="socialConnectGooglePlusButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $googlePlusLink; ?>">
				<i></i>
				<span>Google+</span>
			</a>
			<?php endif; ?>
			<?php if($linkedin): ?>
			<a title="::LinkedIn" class="socialConnectLinkedInButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $linkedinLink; ?>">
				<i></i>
				<span>LinkedIn</span>
			</a>
			<?php endif; ?>
			<?php if($github): ?>
			<a title="::GitHub" class="socialConnectGitHubButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $githubLink; ?>">
				<i></i>
				<span>GitHub</span>
			</a>
			<?php endif; ?>
			<?php if($wordpress): ?>
			<a title="::WordPress" class="socialConnectWordPressButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $wordpressLink; ?>">
				<i></i>
				<span>WordPress</span>
			</a>
			<?php endif; ?>
			<?php if($windows): ?>
			<a title="::Microsoft" class="socialConnectWindowsLiveButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $windowsLink; ?>">
				<i></i>
				<span>Microsoft</span>
			</a>
			<?php endif; ?>
			<?php if($ning): ?>
			<a title="::<?php echo $params->get('ningNetworkName'); ?>" class="socialConnectNingButton socialConnectButton socialConnectServiceButton socialConnectClearFix hasTip" href="<?php echo $ningLink; ?>">
				<i></i>
